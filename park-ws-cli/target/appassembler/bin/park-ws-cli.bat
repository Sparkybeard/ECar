...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="park-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.ecar.park.ws.cli.ParkClientApp %CMD_LINE_ARGS%
